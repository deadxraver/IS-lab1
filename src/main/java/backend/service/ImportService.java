...
public class ImportService {
    ...
    public Long importFromXml(InputStream xmlStream, String username) {
        ...
        try (Connection conn = ds.getConnection()) {
            ...
            try {
                routeRepository.findAll(0, 1);

                List<Route> routes = parseAndValidate(xmlStream);
                ...
                try {
                    historyId = importRepository.insertOperation(null, username, "SUCCESS", addedCount);
                } catch (Exception e) {
            ...
            throw new RuntimeException("Failed to obtain DB connection for import", e);
        }
    }
